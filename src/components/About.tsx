...
export default function About() {
  const highlights = [
    {
      icon: <Code2 className="text-brand-primary" size={24} />,
      title: "Full Stack Engineering",
      desc: "Robust backends in Python/Django & interactive frontends in React.js and Next.js.",
    },
    {
      icon: <ShieldAlert className="text-brand-secondary" size={24} />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-8">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative group w-80 h-80 sm:w-96 sm:h-96">
              ...
              <div className="absolute inset-0 border border-brand-primary/20 rounded-full animate-spin-slow pointer-events-none" style={{ animationDuration: "20s" }} />
              <div className="absolute inset-4 border border-dashed border-brand-secondary/20 rounded-full animate-spin-slow pointer-events-none" style={{ animationDuration: "10s", animationDirection: "reverse" }} />
              <div className="absolute inset-10 border border-double border-brand-primary/10 rounded-full animate-spin-slow pointer-events-none" style={{ animationDuration: "30s" }} />
              
              {/* Outer glowing border */}
              <div className="absolute -inset-2 rounded-2xl bg-gradient-to-tr from-brand-primary via-brand-secondary to-slate-900 opacity-25 blur-lg group-hover:opacity-40 transition-opacity duration-500" />
              ...
              <div className="relative w-full h-full rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl p-5 overflow-hidden flex flex-col justify-between shadow-2xl">
                ...
                <div className="my-auto flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="relative w-28 h-28 rounded-full bg-slate-950 flex items-center justify-center border-2 border-brand-primary/40 group-hover:border-brand-primary transition-colors shadow-[0_0_30px_var(--theme-glow)] group-hover:shadow-[0_0_40px_var(--theme-glow)] transform group-hover:scale-105 transition-transform duration-300">
                    
                    {/* Pulsing inner dot */}
                    <div className="absolute w-20 h-20 rounded-full border border-dashed border-brand-secondary/40 animate-spin" style={{ animationDuration: "12s" }} />
                    <div className="absolute inset-2 rounded-full bg-gradient-to-br from-slate-950 to-slate-900 flex items-center justify-center">
                      <span className="text-3xl font-mono font-extrabold bg-gradient-to-r from-brand-primary to-brand-secondary bg-clip-text text-transparent">AS</span>
                    </div>
                  </div>

                  <div className="text-center space-y-2">
                    <h3 className="text-lg font-bold text-white font-mono tracking-wide">Abhiraj Singh</h3>
                    <p className="text-xs text-brand-primary font-mono">&lt;FullStackPythonDeveloper /&gt;</p>
                ...
                <div className="flex items-center justify-between text-[9px] font-mono text-slate-400 border-t border-slate-800/60 pt-3">
                  <span className="text-brand-primary flex items-center gap-1 font-bold">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                Hi, I'm <strong className="text-brand-primary font-bold">Abhiraj Singh</strong>. 
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                Having transitioned passionately into web development, I master foundational technologies (HTML, CSS, JS, SQL) and advanced server architectures using <strong className="text-brand-primary font-bold">Python and Django</strong>. 
              ...
              <p className="text-brand-primary font-semibold font-mono text-sm border-l-2 border-brand-primary pl-4 py-1 bg-brand-primary/5 rounded-r-lg">
